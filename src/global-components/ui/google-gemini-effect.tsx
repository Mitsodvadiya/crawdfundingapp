...
export const GoogleGeminiEffect = ({
    ...
    return (
        ...
        works!`}
            ...
            <div className="flex flex-row items-center justify-center gap-3 pt-10 z-50 relative">
                <Button className="!cursor-pointer" onClick={() => router.push("/admin")}>
                    Create Campaigns
                </Button>
                <Button className="bg-transparent text-white border border-white !cursor-pointer hover:bg-white hover:text-black" onClick={() => router.push("/campaigns")}>
                    Start Funding
                </Button>
            </div>
            <div className="w-full h-[890px] -top-50 md:-top-40 flex items-center justify-center bg-red-transparent absolute ">
                <button className="font-bold rounded-full md:px-4 md:py-2 px-2 py-2 md:mt-24 mt-8 z-30 md:text-base text-black text-xs w-fit mx-auto backdrop-blur-xs bg-white/10">
                    <Image src={"/images/logo.png"} alt="join us" width={100} height={100} />
                </button>
            </div>
            <svg
                width="1440"
